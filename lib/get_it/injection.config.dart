...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i13.NewPurchaseOrderBloc>(
        () => _i13.NewPurchaseOrderBloc(gh<_i11.GRNRepository>()));
    gh.lazySingleton<_i14.ProductSelectionRepo>(
        () => _i15.ProductSelectionRepoImpl(gh<_i3.Client>()));
    ...
    gh.factory<_i24.CreateGrnCubit>(
        () => _i24.CreateGrnCubit(gh<_i11.GRNRepository>()));
    gh.factory<_i25.FetchBusinessPartnerBloc>(
        () => _i25.FetchBusinessPartnerBloc(gh<_i14.ProductSelectionRepo>()));
    gh.factory<_i26.FetchOrderedproductBloc>(
        () => _i26.FetchOrderedproductBloc(gh<_i11.GRNRepository>()));
    gh.factory<_i27.FetchProductBloc>(
        () => _i27.FetchProductBloc(gh<_i14.ProductSelectionRepo>()));
    gh.factory<_i28.FetchProductCategoryBloc>(
        () => _i28.FetchProductCategoryBloc(gh<_i14.ProductSelectionRepo>()));
    gh.factory<_i29.FetchPurchaseOrderBloc>(
        () => _i29.FetchPurchaseOrderBloc(gh<_i11.GRNRepository>()));
    gh.factory<_i30.FetchShipmentBloc>(
        () => _i30.FetchShipmentBloc(gh<_i16.ShipmentRepo>()));
    gh.factory<_i31.NewShipmentBloc>(
        () => _i31.NewShipmentBloc(gh<_i16.ShipmentRepo>()));
