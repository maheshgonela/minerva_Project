...
import 'package:base_auth/base_auth.dart' as _i30;
import 'package:base_auth/repository/auth_repository.dart' as _i18;
import 'package:get_it/get_it.dart' as _i1;
import 'package:http/http.dart' as _i3;
import 'package:injectable/injectable.dart' as _i2;
import 'package:minerva/app_version_usecase.dart' as _i17;
...
import 'package:minerva/features/sign_in/presentation/bloc/sign_in_bloc/sign_in_bloc.dart'
    as _i29;
import 'package:minerva/get_it/external_libs_injection_module.dart' as _i32;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i13.ShipmentRepo>(
        () => _i14.ShipmentRepoImpl(gh<_i3.Client>()));
    gh.factory<_i15.ShopTripsBloc>(
        () => _i15.ShopTripsBloc(gh<_i4.DispatchRepository>()));
    gh.factory<_i16.TabletDispatchCubit>(
        () => _i16.TabletDispatchCubit(gh<_i4.DispatchRepository>()));
    gh.factory<_i17.AppVersionUseCase>(
        () => _i17.AppVersionUseCase(gh<_i3.Client>()));
    gh.lazySingleton<_i18.AuthRepository>(
        () => _i19.SignInRepoImpl(gh<_i3.Client>()));
    gh.factory<_i20.CreateDispatchCubit>(
        () => _i20.CreateDispatchCubit(gh<_i4.DispatchRepository>()));
    gh.factory<_i21.CreateGrnCubit>(
        () => _i21.CreateGrnCubit(gh<_i11.GRNRepository>()));
    gh.factory<_i22.FetchBusinessPartnerBloc>(
        () => _i22.FetchBusinessPartnerBloc(gh<_i13.ShipmentRepo>()));
    gh.factory<_i23.FetchOrderedproductBloc>(
        () => _i23.FetchOrderedproductBloc(gh<_i11.GRNRepository>()));
    gh.factory<_i24.FetchProductBloc>(
        () => _i24.FetchProductBloc(gh<_i13.ShipmentRepo>()));
    gh.factory<_i25.FetchProductCategoryBloc>(
        () => _i25.FetchProductCategoryBloc(gh<_i13.ShipmentRepo>()));
    gh.factory<_i26.FetchPurchaseOrderBloc>(
        () => _i26.FetchPurchaseOrderBloc(gh<_i11.GRNRepository>()));
    gh.factory<_i27.FetchShipmentBloc>(
        () => _i27.FetchShipmentBloc(gh<_i13.ShipmentRepo>()));
    gh.factory<_i28.NewShipmentBloc>(
        () => _i28.NewShipmentBloc(gh<_i13.ShipmentRepo>()));
    gh.factory<_i29.SignInBloc>(
        () => _i29.SignInBloc(signInRepo: gh<_i30.AuthRepository>()));
    gh.factory<_i31.AuthBloc>(() => _i31.AuthBloc(
          repository: gh<_i30.AuthRepository>(),
          appVersionUseCase: gh<_i17.AppVersionUseCase>(),
        ));
    return this;
  }
}

class _$ExternalLibs extends _i32.ExternalLibs {}
