...
class _CategorySelecterState extends State<CategorySelecter> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: BlocListener<FetchProductBloc, FetchProductState>(
        listener: (context, state) {
          state.when(
            initial: () {},
            loading: () {},
            success:
                (product, hasReachedMax, fetchedCategories, query, barCode) {
              print('JIJIJIJI');
              print('Fetched Categories: $fetchedCategories');
              selectedCategoryList.addAll(fetchedCategories);
              setState(() {});
            },
