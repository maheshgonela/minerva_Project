...
class _$OrderedProductImpl implements _OrderedProduct {
  const _$OrderedProductImpl(
      ...
      required this.selectedReceivedQty});
  ...
  @override
  String toString() {
    return 'OrderedProduct(id: $id, organization: $organization, product: $product, productCode: $productCode, productCategory: $productCategory, subCategory: $subCategory, productName: $productName, uOM: $uOM, uOMName: $uOMName, orderedQuantity: $orderedQuantity, pendingQty: $pendingQty, selectedReceivedQty: $selectedReceivedQty)';
  }
